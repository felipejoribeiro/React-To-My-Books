...
class App extends Component {
  ...
  // The arrow function here is very important as it passes a reference of the
  // function and not the function. The consequence of this is that it
  // carries the references from this class.
